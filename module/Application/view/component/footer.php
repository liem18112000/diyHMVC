...
<footer class="footer-bs">
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 footer-social animated fadeInDown">
            <h4>Follow Us</h4>
            <ul>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 footer-ns animated fadeInRight">
            <h4>Newsletter</h4>
