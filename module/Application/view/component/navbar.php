            ...
            <?php if (isset($_SESSION['login'])) { ?>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownId2">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="<?= Customer['paths']['url'] . '/customer/checkAttendance' ?>"><i class="fa fa-check-square-o" aria-hidden="true"> <?= ucwords(Translator::translate('attendance')) ?></i></a>
                    </div>
                </li>
                <li class="nav-item dropdown">
